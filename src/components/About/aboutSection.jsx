                    ...
                    <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="md:mt-14 mt-12 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">N.F Maleka Attorneys Inc. is a firm of attorneys who are passionate about serving its clients.</p>
                            </div>
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">We believe, that to give real service, you will need to bring something which can never be measured with money and that is sincerity and integrity. </p>
                            </div>
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">The firm is founded upon strong values such as sincerity, humanity and integrity with the strong belief that every client deserves the best tailor made legal support and solutions to meet and handle their legal affairs.</p>
                            </div>
                        </div>
                    </div>
